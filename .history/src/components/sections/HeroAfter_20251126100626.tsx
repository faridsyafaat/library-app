...
export default function HeroAfter() {
  ...
  // ❌ autoplay akan berhenti selamanya setelah user klik dot
  ...
  // ⭐ autoplay berjalan hanya kalau isPaused = false
  useEffect(() => {
  ...
  return (
    <div className="w-full">
      <div className="relative w-full h-[450px] overflow-hidden rounded-2xl">
        ...
        {/* Main book cover tidak terpotong */}
        <motion.img
          key={books[index].id}
          src={currentCover}
      ...
      <div className="flex justify-center mt-4 gap-3">
        {books.map((_, i) => (
          <button
            ...
            onClick={() => {
              setIndex(i);
              setIsPaused(true); // ⛔ stop autoplay permanen
            }}
