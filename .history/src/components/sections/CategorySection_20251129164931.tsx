  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        // Cek apakah response ada data categories
        if (res.data?.data && Array.isArray(res.data.data)) {
          setCategories(res.data.data);
        } else if (res.data?.data?.categories && Array.isArray(res.data.data.categories)) {
