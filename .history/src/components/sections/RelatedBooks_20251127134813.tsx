...
export default function RelatedBooks({
  ...
  const { data: relatedBooks, isLoading, isError } = useQuery<BookType[]>({
    ...
    enabled: !!categoryName, // hanya fetch jika categoryName valid
  });

  // Debugging cepat
  console.log("CategoryName:", categoryName);
  console.log("CurrentBookId:", currentBookId);
  console.log("RelatedBooks data:", relatedBooks);
  ...
  if (!relatedBooks?.length) return <p className="p-4 text-gray-500">No related books found</p>;
