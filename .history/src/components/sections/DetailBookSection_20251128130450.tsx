...
export default function DetailBookSection() {
  ...
  // SINGLE handler (no duplicate)
  const handleAddToCart = () => {
    dispatch(
      addToCartAsync({
        bookId: book.id,
        // optionally include userId here if your backend needs it:
        // userId: someUserId
      })
    ).then(() => {
      navigate("/mycart");
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="col-span-2">
          ...
          {/* stats & description omitted for brevity in this snippet (keep yours unchanged) */}
