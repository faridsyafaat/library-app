...
// Dummy fallback data
const fallbackBooks: RelatedBookItem[] = [ { id: 2, title: "The Psychology of Money", author: "Jason Zweig", rating: 4, coverImage: "/image/book2.png" }, { id: 3, title: "Lisa Kleypas", author: "Irresistible", rating: 4, coverImage: "/image/book3.png" }, { id: 4, title: "Oliver Twist", author: "Charles Dickens", rating: 3, coverImage: "/image/book4.png" }, ];
...
export default function RelatedBooks({ currentBookId, categoryName }: RelatedBooksProps) {
  ...
  // Fallback dummy jika API gagal atau data kosong
