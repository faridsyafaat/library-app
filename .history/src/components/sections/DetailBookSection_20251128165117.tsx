...
import { Share2 } from 'lucide-react';
 ...
 interface DetailBookSectionProps {bookId: number;}
...
export default function DetailBookSection({ bookId }: DetailBookSectionProps) {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      await axios.post('https://be-library-api-xh3x6c5iiq-et.a.run.app/api/books/1', { bookId: book.id, quantity: 1 });
