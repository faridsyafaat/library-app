...
const categoryImages: Record<string, string> = {
  ...
  // Sesuaikan kategori dari backend
...
export default function CategorySection() {
  ...
  // 🔐 FIX untuk mencegah useEffect dipanggil 2 kali oleh React Strict Mode
  ...
  return (
    <div className="w-full container py-6">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {categories.map((cat) => {
          const imageUrl = categoryImages[cat.name] || "/image/fallback.png";
