...
const NavbarAfter = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-sm px-4 py-3 flex items-center justify-between container mx-auto">


     {/* Logo + Tulisan */}
      <Link to="homeafter" className="flex items-center gap-4">
        <img
          src="image/logo.png"
          alt="Logo"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative cursor-pointer">
          <img src="image/bag.png" className="w-9" alt="Cart" />
          {cartCount > 0 && (
