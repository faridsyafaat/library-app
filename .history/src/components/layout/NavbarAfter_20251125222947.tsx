...
const NavbarAfter = () => {
  ...
  return (
    <nav className="w-full bg-white shadow-sm px-4 py-3 flex items-center justify-between container mx-auto">
      ...
      {/* Logo + Tulisan */}
      <Link to="/homeafter" className="flex items-center gap-2">
        <img
          src="/icon/logo.png"
          alt="Logo"
        ...
        <span className="text-2xl font-bold text-gray-800 hidden sm:inline">Booky</span>
      </Link>

      {/* Search Bar Desktop */}
      <div className="hidden sm:flex relative w-[500px] h-[44px] flex items-center gap-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-medium hidden sm:inline">{user?.name || "John Doe"}</span>
        </div>
