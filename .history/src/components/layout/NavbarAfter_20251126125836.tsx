...
const NavbarAfter = () => {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-white shadow-sm px-4 py-3 flex items-center justify-between container mx-auto">

      
      {/* Logo + Tulisan */}
      <Link to="/homeafter" className="flex items-center gap-6">
        <img
          src="/icon/logo.png"
          alt="Logo"
