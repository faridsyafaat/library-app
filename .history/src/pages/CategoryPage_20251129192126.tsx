...
export default function CategoryPage() {
  ...
  return (
    <>
      ...
      {/* Judul fixed */}
      <h1 className="text-2xl font-bold fixed top-0 left-0 right-0 bg-white z-30 py-4 px-4 shadow">
        Book List
      </h1>

      {/* Layout: Sidebar + Konten */}
      {/* mt-24 untuk offset konten di bawah judul */}
      <div className="flex w-full gap-x-4 mt-24 container mx-auto">
        {/* Sidebar kiri sticky */}
