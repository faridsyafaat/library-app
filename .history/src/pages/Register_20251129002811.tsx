...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. AUTO LOGIN (karena register tidak mengembalikan token)
      ...
      if (!token) {
        setApiError("Auto-login failed. No token received.");
        return;
      }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-xl bg-white p-4 sm:p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          {/* PHONE */}
          <div>
            <label className="mb-1 block font-medium">Nomor Handphone</label>
            <input
              type="tel"
              name="phone"
              value={form.phone}
