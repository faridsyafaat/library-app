...
export default function CategoryPage() {
    ...
    const fetchBooks = async () => {
      ...
      try {
        const res = await axios.get(
          `https://be-library-api-xh3x6c5iiq-et.a.run.app/api/books/1/${id}`
        );
  ...
  return (
    <>
      ...
      <h1 className="mt-8 text-2xl container font-bold">Book List</h1>
     
      <div className="mt-6 max-w-7xl mx-auto flex gap-10">
