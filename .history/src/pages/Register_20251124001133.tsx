      ...
      <div className="w-full max-w-md rounded-xl bg-white p-4 sm:p-6 shadow-xl">
       ...
       {apiError && (
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-[#1C65DA] py-3 font-semibold text-white hover:bg-blue-600"
          >
            Submit
          </button>
        </form>

     <div className="flex min-h-screen items-start justify-center bg-gray-50 px-4 py-6 overflow-auto">
  <div className="w-full max-w-md rounded-xl bg-white p-4 sm:p-6 shadow-xl flex flex-col">
    <form className="space-y-3 sm:space-y-4 overflow-auto">
      {/* semua input */}
    </form>
