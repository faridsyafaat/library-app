    ...
    <>
      ...
      <div className="container mx-auto p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {selectedItems.map((item: SelectedBook) => (
              <div key={item.id} className="flex gap-4 items-start border p-3 rounded-lg">
                ...
                <div className="flex flex-col justify-between h-20">
                  <p className="text-sm text-gray-500">{item.book.category || "Unknown"}</p>
        ...
        <div className="border p-6 rounded-2xl shadow space-y-6">
          ...
          {/* Borrow Date */}
          <div className="mb-4">
            <label className="block font-semibold font-medium mb-1">Borrow Date</label>
          ...
          <div>
            <p className="font-medium font-semibold mb-1">Borrow Duration</p>
            <label>
          ...
          {/* Return Date */}
          <div className="mb-4">
            <p className="font-medium  font-semibold mb-1">Return Date</p>
