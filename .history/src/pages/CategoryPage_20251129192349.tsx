...
export default function CategoryPage() {
  ...
  return (
    <>
      ...
      {/* Judul sticky */}
      <h1 className="text-2xl font-bold sticky top-0 bg-white z-30 py-4 container mx-auto">
        Book List
      </h1>
      ...
      <div className="flex w-full gap-x-4 mt-4 container mx-auto">
        {/* Sidebar kiri sticky */}
        <div className="w-1/3 sticky top-[7rem] max-h-[calc(100vh-7rem)] overflow-y-auto z-20">
          <FilterSidebar />
        </div>

        {/* Konten kanan */}
        <div className="w-2/3 min-h-[calc(100vh-7rem)] mb-6">
