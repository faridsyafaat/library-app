...
export default function AuthorPage() {
  ...
  if (authorLoading || booksLoading) {
    return (
      <div className="w-full flex justify-center text-2xl py-10 text-gray-500">
        Loading ...
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div className="container py-10">
        ...
        <div 
        key={books.id}
        className="bg-white shadow rounded-2xl p-6 flex items-center gap-4 mb-10"
        onClick={() => navigate(`/detail/$(book.id)`)}>
          ...
          <div>
            <h1 className="text-3xl text-gray-600 font-bold">{books [0].Author?.name || "Unknown Author"}</h1>
            ...
            {books.map((book) => (
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <p className="text-gray-600 text-sm">{book.Author?.name || "Unknown Author"}</p>
