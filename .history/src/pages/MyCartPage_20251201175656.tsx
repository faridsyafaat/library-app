...
export default function MyCartPage() {
  ...
  if (isLoading) return <Spinner message="Loading your cart..." />;
  if (isError) return <Alert type="error" message="Failed to load cart data." />;
...
borrowMutation.mutate({
  cartId: data.data.cartId,
          ...
          items: selectedItems.map((id: number) => ({
            cartItemId: id,
          })),
        });
      }}
