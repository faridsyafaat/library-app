...
const CheckoutPage = () => {
  ...
  {/* Sisi kiri */}
  <div className="space-y-1 text-semibold">
    <p><b>Name</b></p>
    <p><b>Email</b></p>
    <p><b>Phone</b></p>
  </div>
  ...
  {/* Sisi kanan */}
  <div className="space-y-1 text-right text-bold">
   <p><b></b> John Doe</p>
    <p><b></b> johndoe@gmail.com</p>
    <p><b></b> 081234567890</p>
  </div>
</section>
        ...
        <div className="border p-6 rounded-2xl shadow space-y-6">
          ...
          <p>
            Return Date: <b>{returnDate.toDateString()}</b>
          </p>
